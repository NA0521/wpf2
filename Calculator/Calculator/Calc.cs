...
namespace Calculator
{
    public class Calc : INotifyPropertyChanged
    {
        ...
        protected void OnPerpertyChanged(string propertyName)
        {
    ...
    class Calculate : ICommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            c.InputString = c.DisplayText = calculate(c.Op, (double)c.Op1, op2).ToString();
            c.Op1 = null;
        }
